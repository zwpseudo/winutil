...
- Windows taking longer to shut down:
  - [#69](https://github.com/zwpseudo/winutil/issues/69) Turn on fast startup: Press Windows key + R, then type:
  ```
  ...
  powercfg /H off
  ```
- [#69](https://github.com/zwpseudo/winutil/issues/69) [95](https://github.com/zwpseudo/winutil/issues/95) [#232](https://github.com/zwpseudo/winutil/issues/232) Windows Search does not work: Enable Background Apps
- [#198](https://github.com/zwpseudo/winutil/issues/198) Xbox Game Bar Activation Broken: Set the Xbox Accessory Management Service to Automatic
```
