        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="50" Name="WPFIcon" SnapsToDevicePixels="True" Source="https://watford.cloud/images/logo-full.png" Margin="0,10,0,10"/>
...
$sync.configs.tweaks = '{
  ...
  "WPFEssTweaksOO": {
    "InvokeScript": [
      "curl.exe -s \"https://raw.githubusercontent.com/zwpseudo/winutil/main/ooshutup10_winutil_settings.cfg\" -o $ENV:temp\\ooshutup10.cfg
